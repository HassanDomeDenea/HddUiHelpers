...
export default definePreset(() => {
  return {
    ...
    shortcuts: [
      ...
      ['bg-frosted-light', `bg-gradient-to-b from-white via-blue-50 to-blue-100 dark:from-slate-900 dark:via-blue-950 dark:to-blue-900`],

      /*Sharp Gradients: */
      ['bg-neon-blue-pink', `bg-gradient-to-tr from-fuchsia-500 via-purple-600 to-sky-500 dark:from-fuchsia-700 dark:via-purple-900 dark:to-sky-800`],
      ['bg-minimal-gray', `bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 dark:from-gray-800 dark:via-gray-900 dark:to-black`],
      ['bg-nature-green', `bg-gradient-to-tr from-emerald-300 via-lime-400 to-green-600 dark:from-emerald-900 dark:via-green-900 dark:to-lime-950`],
      ['bg-cool-ocean', `bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600 dark:from-cyan-900 dark:via-blue-900 dark:to-indigo-950`],
      ['bg-sunset-orange-pink', `bg-gradient-to-br from-orange-300 via-pink-400 to-rose-500 dark:from-orange-800 dark:via-pink-800 dark:to-rose-900`],
      [
      ...
      /*Calm Gradients: */
      ['bg-calm-sky', `bg-gradient-to-br from-sky-100 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-sky-950 dark:to-indigo-950`],
      ['bg-soft-mint', `bg-gradient-to-br from-teal-50 via-green-50 to-emerald-100 dark:from-emerald-900 dark:via-teal-950 dark:to-green-950`],
      ['bg-morning-mist', `bg-gradient-to-b from-gray-50 via-slate-100 to-gray-200 dark:from-gray-900 dark:via-slate-950 dark:to-black`],
      ['bg-blush-petal', `bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100 dark:from-rose-900 dark:via-pink-950 dark:to-rose-950`],
      [
        'bg-lavender-dream',
      ...
      ['bg-misty-forest', `bg-gradient-to-tr from-emerald-100 via-green-50 to-lime-100 dark:from-emerald-950 dark:via-green-950 dark:to-lime-950`],
      ['bg-cloudy-silver', `bg-gradient-to-br from-slate-50 via-gray-100 to-zinc-200 dark:from-slate-900 dark:via-gray-950 dark:to-zinc-950`],
      ['bg-arctic-breeze', `bg-gradient-to-br from-cyan-50 via-sky-50 to-slate-100 dark:from-cyan-950 dark:via-sky-950 dark:to-slate-950`],
      ['bg-soft-aqua', `bg-gradient-to-br from-teal-100 via-cyan-50 to-blue-100 dark:from-teal-950 dark:via-cyan-950 dark:to-blue-950`],
      ['bg-peaceful-sand', `bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-100 dark:from-amber-900 dark:via-yellow-950 dark:to-orange-950`],

      ['bg-calm-sky-contrast', `bg-gradient-to-br from-sky-200 via-blue-100 to-indigo-200 dark:from-slate-800 dark:via-sky-900 dark:to-indigo-950`],
      [
      ...
      ['bg-morning-mist-contrast', `bg-gradient-to-b from-gray-100 via-slate-200 to-gray-300 dark:from-gray-800 dark:via-slate-900 dark:to-black`],
      ['bg-blush-petal-contrast', `bg-gradient-to-br from-rose-200 via-pink-100 to-rose-200 dark:from-rose-800 dark:via-pink-900 dark:to-rose-950`],
      [
      ...
      ['bg-arctic-breeze-contrast', `bg-gradient-to-br from-cyan-200 via-sky-100 to-slate-200 dark:from-cyan-900 dark:via-sky-950 dark:to-slate-950`],
      ['bg-soft-aqua-contrast', `bg-gradient-to-br from-teal-200 via-cyan-100 to-blue-200 dark:from-teal-900 dark:via-cyan-950 dark:to-blue-950`],
      [
