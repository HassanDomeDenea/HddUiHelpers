import { defineComponent as Pt, useModel as se, ref as m, computed as x, onBeforeMount as Mt, onMounted as Vt, resolveComponent as W, openBlock as s, createElementBlock as f, createElementVNode as c, renderSlot as V, toDisplayString as k, normalizeClass as ue, createCommentVNode as v, Fragment as w, renderList as j, unref as o, createTextVNode as X, createVNode as C, mergeProps as de, withCtx as h, createBlock as b, normalizeStyle as fe, createSlots as At, withDirectives as I, withKeys as ce, mergeModels as De } from "vue";
import P from "primevue/button";
import Y from "primevue/column";
import Nt from "primevue/contextmenu";
import Et from "primevue/datatable";
import ve from "primevue/inputtext";
import z from "primevue/tooltip";
import { map as Ot, filter as It, reduce as $e, cloneDeep as zt, debounce as Dt, get as D, isBoolean as $, upperFirst as $t, unset as Lt } from "lodash-es";
import Le from "moment";
import Tt from "primevue/datepicker";
import { useConfirm as Ht } from "primevue/useconfirm";
import { useToast as Ut } from "primevue/usetoast";
import qt from "HddUiHelpers/utils/usePrimeVueServerUi";
import { printDomWithStyles as Kt } from "HddUiHelpers/utils/printDom";
import Wt from "HddUiHelpers/components/datatables/ServerFormDialog.vue";
import { _ as jt } from "./MultiSelectColumnFilter.vue_vue_type_script_setup_true_lang-F3KuQ6Hf.js";
import { _ as Yt } from "./SelectColumnFilter.vue_vue_type_script_setup_true_lang-Df0JutHc.js";
import { FilterMatchMode as Ce } from "./components/primeVueServerTable/types.js";
const Gt = { class: "p-server-datatable-container max-w-full px-4" }, Jt = { class: "hidden" }, Qt = { class: "my-2 text-center text-xl font-bold" }, Xt = ["dir"], Zt = { class: "printable-table mx-auto mt-3" }, _t = { key: 0 }, el = { key: 0 }, tl = ["innerHTML"], ll = { class: "my-2 text-xl font-bold" }, al = { class: "flex w-full items-end" }, ol = {
  key: 0,
  class: "justify-content-between flex flex-1 gap-1"
}, rl = { class: "flex flex-1 justify-end gap-1" }, il = ["for"], nl = { class: "flex w-full justify-end gap-1 text-sm" }, sl = { key: 0 }, ul = { class: "flex items-center gap-1 text-sm" }, dl = { key: 0 }, fl = { class: "text-secondary-1 text-center text-sm italic" }, cl = {
  key: 0,
  class: "flex justify-end"
}, vl = ["innerHTML"], pl = { class: "flex flex-wrap items-center gap-1" }, El = /* @__PURE__ */ Pt({
  ...
  setup(r, { expose: Te, emit: He }) {
    ...
    const F = se(r, "rowsPerPage"), G = se(r, "sorts"), qe = se(r, "isCollapsed"), Z = m(), _ = {
    ...
    }, A = m({ global: { value: null, matchMode: "contains" } }), ee = Ut(), Ke = Ht(), We = m(), N = m(!1), B = m(0), te = m(0), E = se(r, "records"), p = m([]), q = m({}), S = m(!1), O = m(0), xe = m(), M = m(), je = x(() => i("dir") === "rtl" ? "right" : "left"), ke = x(() => {
      ...
      return a.openable && e.push({
        ...
        ...zt(a.extraContextMenuOptions).map((t) => (t.command && (t.command2 = t.command, t.command = () => t.command2(M.value)), typeof t.labelFn == "function" && (t.label = t.labelFn(M.value)), t))
      ), e;
    }), Qe = x(() => ({
      text: [
          ...
          J.value ? (s(), f("div", {
            ...
            c("div", {
              ...
              c("table", Zt, [
                c("thead", null, [
                  c("tr", null, [
                    r.hasSequenceColumn ? (s(), f("th", _t, "#")) : v("", !0),
                ...
                c("tbody", null, [
                  (s(!0), f(w, null, j(ae.value || E.value, (l, d) => (s(), f("tr", {
                    ...
                    r.hasSequenceColumn ? (s(), f("td", el, k(d + 1), 1)) : v("", !0),
        ...
        C(o(Et), {
          ...
          header: h(() => [
            V(e.$slots, "title", { records: E.value }, () => [
              c("div", ll, k(r.tableTitle), 1)
            ]),
            c("div", al, [
              r.hasGlobalFilter ? (s(), f("div", ol, [
                C(u, null, {
                  default: h(() => [
          ...
          paginatorstart: h(() => [
            c("div", nl, [
              ...
              p.value.length ? (s(), f("span", sl, k(o(i)("(n Records selected)", { n: p.value.length }, p.value.length)), 1)) : v("", !0)
            ])
          ]),
          paginatorend: h(() => [
            c("div", ul, [
              ...
              F.value !== -1 ? (s(), f("span", dl, k(o(i)("Entries")), 1)) : v("", !0)
            ])
          ]),
          empty: h(() => [
            c("div", fl, k(o(i)("No Data")), 1)
          ]),
          expansion: h(({ data: l }) => [
          ...
          default: h(() => [
            ...
            (s(!0), f(w, null, j(r.columns, (l) => (s(), f(w, {
              ...
              l.type !== "hidden" ? (s(), b(o(Y), de({
                ...
                field: l.name,
                header: l.header || (r.autoI18nColumnsHeader ? o(i)(o($t)(l.name)) : l.name),
