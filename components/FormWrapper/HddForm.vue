...
const submitButtonRef = useTemplateRef<
  ComponentExposed<typeof Button> & { $el: HTMLButtonElement }
>("submitButtonRef");
...
function resolveFieldOptions(
  ...
  return typeof _options === "function"
    ? (_options(_currentValues) as any[])
    : ((toValue(_options) ?? []) as any[]);
}
