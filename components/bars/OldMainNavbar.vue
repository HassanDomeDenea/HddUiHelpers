    ...
    <template #end>
      <div class="flex items-center gap-2">
        ...
        <div
          ...
          tabindex="0"
          class="i-mdi-checkbox-blank-circle text-success outline-solid inline-block text-2xl shadow-lg"
          @click="pingServer"
        />
        <div
          v-else
          v-tooltip="t(generalStore.websocketConnectionState)"
          class="i-material-symbols:warning-rounded text-warning outline-solid inline-block text-2xl shadow-lg"
        />
      </div>
    </template>
  </Menubar>
