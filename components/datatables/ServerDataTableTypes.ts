...
export type ColumnSelectOptions = LocalListType
...
export interface ServerDataTableColumn<TType extends ServerDataTableColumnType = ServerDataTableColumnType, TRow = Record<string, any>> {
    ...
    renderTypeProps?: MaybeRefOrGetter<((event: {
                                             value: any,
                                             text: any,
                                             row: TRow,
...
export interface PrintPaperForServerDataTableProps<TRecord extends RecordItem = RecordItem> {
    ...
    getData: (specificPerPage?: number | null, specificPage?: number | null, requestConfig?: AxiosRequestConfig) => Promise<AxiosResponse<ApiResponseData<ResponseData>>>;
