...
<template>
    <div>
        ...
        <div :class="{ 'my-2 ms-6 me-1 rounded-lg border-1 border-dashed border-zinc-600 dark:border-zinc-500/75': isGrouped }">
            <span
...
<style scoped>
.operator-span {
    @apply mx-1 cursor-pointer rounded px-1 font-bold text-zinc-500 italic hover:bg-gray-200/75 dark:text-zinc-300 hover:dark:bg-gray-700/75;
}
</style>
