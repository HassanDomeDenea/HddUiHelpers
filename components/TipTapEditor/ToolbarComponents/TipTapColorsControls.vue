  ...
  <div class="relative inline-flex flex-wrap">
    ...
    <ButtonGroup>
        ...
        <template #icon="slotProps">
          ...
          >
            <span
              ...
              :style="{
                background: editor.getAttributes('highlight')?.color ?? recentHighlightColor,
              }"
            />
            <i
              ...
              :style="{
                color: editor.isActive('highlight')
                  ? (editor.getAttributes('highlight')?.color ?? recentHighlightColor)
                  : null,
              }"
            />
          </span>
      ...
      <Button
        ...
        @click="
          (event) =>
            recentTextColor && !editor.getAttributes('textStyle')?.color
              ? setTextColor()
              : textColorPickerRef.toggle(event)
        "
      ...
      >
        <template #icon="slotProps">
          ...
          >
            <span
              class="z-1 pointer-events-none absolute bottom-0 left-0 right-0 top-0 flex items-end justify-stretch"
            >
              <i
            ...
            <i class="i-ooui:larger-text transform-origin-top-center scale-90" />
          </span>
        </template>
      </Button>
    </ButtonGroup>
