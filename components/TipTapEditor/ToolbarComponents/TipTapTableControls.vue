...
const insertTablePopoverRef =
  useTemplateRef<ComponentExposed<typeof Popover>>("insertTablePopoverRef");
...
function confirmInsertTable() {
  editor
    ...
    .focus()
    .insertTable({
      rows: insertTableModel.value.rows,
      cols: insertTableModel.value.cols,
      withHeaderRow: insertTableModel.value.withHeader,
    })
    .run();
...
<template>
  <div class="inline-flex flex-wrap">
    ...
    />
    <Menu ref="tableOptionsMenuRef" :model="tableOptionsMenuItems" popup />
    ...
    <Popover ref="insertTablePopoverRef">
      <div class="space-y-2 p-1">
        ...
        <div class="flex items-center gap-1">
          ...
          <Checkbox
            v-model="insertTableModel.withHeader"
            size="small"
            :input-id="insertTableModel.withHeaderId"
            binary
          />
        </div>
