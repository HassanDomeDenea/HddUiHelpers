...
<template>
  <div class="inline-flex items-center">
    <i
      v-tooltip="isCollapsed ? (expandText ?? t('Expand')) : (collapseText ?? t('Collapse'))" tabindex="0"
      :class="{ [collapsedClass ?? 'dark:(text-teal-500 hover:text-teal-400) light:(text-teal-500 hover:text-teal-700)']: isCollapsed,
