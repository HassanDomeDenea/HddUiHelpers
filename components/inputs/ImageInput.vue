...
<template>
  <BaseInput v-bind="baseInputForwardedProps">
    <div
      ...
      :class="{
        'border-amber border-1 border-dashed rounded-lg bg-amber-100/25 dark:bg-amber-700/45':
    ...
    >
      <div>
        ...
        <Button
          ref="inputRef"
          :size="size"
          :label="uploadButtonLabel ?? t('Choose File')"
          :disabled="disabled"
          :icon="uploadButtonIcon ?? 'pi pi-upload'"
